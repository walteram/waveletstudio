...
SetupIconFile=..\res\images\icons\icon.ico
...
brazilianportuguese.DotNetNeeded=Baixando o Microsoft .NET Framework 4.0
...
[PreCompile]
#Name: "%windir%\Microsoft.Net\Framework\v4.0.30319\msbuild.exe"; Parameters: "/property:Configuration=Release;OutputDir={src}\files\library {src}\WaveletStudio\WaveletStudio.csproj"
Name: "%windir%\Microsoft.Net\Framework\v4.0.30319\msbuild.exe"; Parameters: "/property:Configuration=Release;OutputDir=%windir%\Microsoft.Net\Framework\v4.0.30319\msbuild.qexe"; Parameters: "/property:Configuration=Release;OutputDir={src}\files\library C:\Wavelet\WaveletStudio\trunk\src\WaveletStudio.sln\temp\files\library C:\Wavelet\WaveletStudio\trunk\src\WaveletStudio.sln"
